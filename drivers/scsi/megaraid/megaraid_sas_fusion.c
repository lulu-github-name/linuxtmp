...
megasas_fusion_update_can_queue(struct megasas_instance *instance, int fw_boot_context)
{
	...
	if (instance->adapter_type < VENTURA_SERIES)
		cur_max_fw_cmds =
		megasas_readl(&instance->reg_set->outbound_scratch_pad_2) & 0x00FFFF;
...
megasas_init_adapter_fusion(struct megasas_instance *instance)
{
	...
	scratch_pad_1 = megasas_readl(&instance->reg_set->outbound_scratch_pad_1);
...
{
	return megasas_readl(&(regs)->outbound_scratch_pad_0);
}
