...
static void xfrm_hash_reset_inexact_table(struct net *net)
{
	...
	list_for_each_entry(b, &net->xfrm_inexact_bins, inexact_bins)
...
static void __xfrm_policy_inexact_flush(struct net *net)
{
	...
	list_for_each_entry(bin, &net->xfrm_inexact_bins, inexact_bins)
...
static void xfrm_policy_fini(struct net *net)
{
	...
	list_for_each_entry_safe(bin, tmp, &net->xfrm_inexact_bins,
				 inexact_bins) {
